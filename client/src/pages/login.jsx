...
import { Zap, Lock, Mail, ArrowRight, Loader2, Sparkles, AlertCircle } from 'lucide-react';
        ...
        <div className="rounded-3xl bg-white border border-slate-200/90 shadow-soft-xl p-7 sm:p-8">
          ...
          <div className="mb-6 p-3.5 rounded-2xl bg-indigo-50/80 border border-indigo-100 flex items-center justify-between">
            ...
            <button
              ...
              className="px-3 py-1.5 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white font-semibold text-xs transition shadow-soft-sm"
            >
              Fill Demo Login
            </button>
          </div>
